...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        amberc: {
            ...
            all: {
                src: [
                    'src/IRI.st', // list all sources in dependency order
                    'src/IRI-Tests.st' // list all tests in dependency order
                ],
                amd_namespace: 'amber-iri',
                libraries: ['SUnit', 'Web']
            },
            test_runner: {
                ...
                libraries: [
                    ...
                    'IRI', /* add other code-to-test packages here */
                    'SUnit',
                    'IRI-Tests' /* add other test packages here */
                ],
